...
public class ImageController {
    ...
    @GetMapping("/delete_post_picture/{id}/delete-img/{imgId}")
    private String deletePicture(@PathVariable("id") Post post,
                                 @PathVariable("imgId") Image image) throws Exception {

        avatarService.remove(image);
