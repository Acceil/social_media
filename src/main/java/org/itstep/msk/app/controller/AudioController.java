...
public class AudioController {
    ...
    private String addAudio(@PathVariable("id") Post post,
        ...
        audioService.addRecordToPost(post, audioRecord);

        return "redirect:/edit_post/" + post.getId();
    }

    @GetMapping("/edit_post/{id}/delete-audio/{audioId}")
    private String deleteAudio(@PathVariable("id") Post post,
                               @PathVariable("audioId") AudioRecord audioRecord) {

        audioService.deleteRecordFromPost(post, audioRecord);
