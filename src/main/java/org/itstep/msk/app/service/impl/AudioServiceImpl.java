...
public class AudioServiceImpl implements AudioService {
    ...
    @Override
    public void addRecordToPost(Post post, AudioRecord audioRecord) {
    ...
    @Override
    public void deleteRecordFromPost(Post post, AudioRecord audioRecord) {
        post.getAudioRecords().remove(audioRecord);
